...
('AutoPartes Guatemala S.A.', 22345678, 'Zona 10, Ciudad de Guatemala', 'ventas@autopartes.com.gt'),
('Repuestos El Motor', 23456789, 'Zona 1, Ciudad de Guatemala', 'info@elmotor.com'),
('Distribuidora Central', 24567890, 'Zona 12, Ciudad de Guatemala', 'contacto@distcentral.com'),
('Importadora Universal', 25678901, 'Villa Nueva, Guatemala', 'ventas@universal.com.gt'),
('Frenos y Suspensiones GT', 26789012, 'Mixco, Guatemala', 'info@frenosgt.com'),
('Lubricantes del Pacífico', 27890123, 'Escuintla, Guatemala', 'ventas@lubpacifico.com'),
('Accesorios Premium Auto', 28901234, 'Zona 9, Ciudad de Guatemala', 'premium@autoacc.com'),
('Baterías y Electricidad SA', 29012345, 'Zona 7, Ciudad de Guatemala', 'contacto@bateriasgt.com'),
('Llantas Continental GT', 30123456, 'Carretera a El Salvador', 'info@llantasgt.com'),
('Filtros Industriales', 31234567, 'Zona 11, Ciudad de Guatemala', 'ventas@filtrosind.com');

INSERT INTO Empleados (nombre_empleado, apellido_empleado, puesto_empleado, email_empleado) VALUES
('Carlos', 'Méndez', 'Gerente', 'carlos.mendez@empresa.com'),
('María', 'López', 'Vendedor', 'maria.lopez@empresa.com'),
('José', 'Hernández', 'Vendedor', 'jose.hernandez@empresa.com'),
('Ana', 'García', 'Cajero', 'ana.garcia@empresa.com'),
('Luis', 'Rodríguez', 'Vendedor', 'luis.rodriguez@empresa.com'),
('Carmen', 'Martínez', 'Supervisor', 'carmen.martinez@empresa.com'),
('Pedro', 'González', 'Vendedor', 'pedro.gonzalez@empresa.com'),
('Sofía', 'Pérez', 'Cajero', 'sofia.perez@empresa.com'),
('Miguel', 'Ramírez', 'Vendedor', 'miguel.ramirez@empresa.com'),
('Laura', 'Torres', 'Vendedor', 'laura.torres@empresa.com');

INSERT INTO Repuestos (nombre_repuesto, categoria_repuesto, precio_compra, precio_venta, id_proveedor) VALUES
('Filtro de Aceite Toyota', 'Filtros', 25.50, 45.00, 1),
('Pastillas de Freno Delanteras', 'Frenos', 120.00, 180.00, 5),
('Batería 12V 45AH', 'Eléctrico', 350.00, 500.00, 8),
('Aceite Motor 10W-40', 'Lubricantes', 75.00, 110.00, 6),
('Llanta 185/65 R15', 'Llantas', 280.00, 420.00, 9),
('Amortiguador Delantero', 'Suspensión', 200.00, 320.00, 5),
('Bujías NGK (set 4)', 'Encendido', 45.00, 75.00, 2),
('Filtro de Aire Honda', 'Filtros', 18.00, 35.00, 10),
('Espejo Retrovisor Lateral', 'Carrocería', 85.00, 140.00, 7),
('Bomba de Agua', 'Sistema de Enfriamiento', 150.00, 240.00, 4);

INSERT INTO Ventas (fecha_venta, cantidad, total, id_empleado, id_repuesto) VALUES
('2025-01-15', 2, 90.00, 2, 1),
('2025-01-16', 1, 180.00, 3, 2),
('2025-01-17', 1, 500.00, 5, 3),
('2025-01-18', 3, 330.00, 7, 4),
('2025-01-19', 4, 1680.00, 2, 5),
('2025-01-20', 2, 640.00, 9, 6),
('2025-01-21', 1, 75.00, 10, 7),
('2025-01-22', 2, 70.00, 3, 8),
('2025-01-23', 1, 140.00, 5, 9),
('2025-01-24', 2, 480.00, 7, 10);
